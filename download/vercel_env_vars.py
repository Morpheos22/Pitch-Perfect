...
env_vars = [
    ("DATABASE_URL", "postgresql://pitchcoach_app:P%21tchC0ach%24ecure2026%21Xz9@aws-1-eu-west-2.pooler.supabase.com:6543/postgres?pgbouncer=true"),
    ...
    ("CLERK_SECRET_KEY", "sk_test_uYJNu2tjMtAdHgux2cPHoloE9gJVKBYpOA1tWhJRXD"),
